...
function updatePlanetMaterialsLive(root, data) {
  root.currentPosition=data?.current_position;
  const position=root.currentPosition;
...
function renderDashboard(state) {
  ...
  renderAtlas(model);
  text("rail-version", `v${model.app?.version || "5.4.3.1"} // WEBVIEW2`);
  text("boot-version", `v${model.app?.version || "5.4.3.1"} // SECURE LOOPBACK // WEBVIEW2`);
  text("about-version", `Version ${model.app?.version || "5.4.3.1"} // HTML Command Deck`);
