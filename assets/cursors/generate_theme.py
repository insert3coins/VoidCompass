...
APP_CURSOR = PROJECT_ROOT / "web" / "assets" / "void-compass-cursor.png"
SIZE = 32
SCALE = 4
CYAN = (21, 189, 232, 255)
BLUE = (20, 118, 201, 255)
...
def main() -> None:
    ...
    # Keep the standalone application cursor beside the Windows theme.
    write_cur(assets["normal-select.cur"][0], ROOT / "VoidCompassCursor.cur", (5, 4))
