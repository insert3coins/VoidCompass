...
from voidcompass.core import themes as _themes
...
PROFILE_TEXT_SETTINGS = (
    ...
    "overlay_hotkey_planet_materials",
    "overlay_hotkey_rhino_minimap",
...
PROFILE_BOOL_SETTINGS = (
    ...
    "planet_materials_overlay_enabled",
    "rhino_minimap_overlay_enabled",
    "powerplay_overlay_enabled",
...
PROFILE_VALUE_SETTINGS = (
    ...
    "prospector_hud_x",
    "prospector_hud_y",
    "planet_materials_hud_x",
    "planet_materials_hud_y",
    "rhino_minimap_hud_x",
    "rhino_minimap_hud_y",
    "powerplay_hud_x",
    "powerplay_hud_y",
...
def load_config():
    ...
    try:
        from voidcompass.core.profile_backups import apply_pending_restore
    ...
    defaults = {
        **OVERLAY_ENABLE_DEFAULTS,
        ...
        'planet_materials_hud_x': 820,
        'planet_materials_hud_y': 80,
        'rhino_minimap_hud_x': 30,
        'rhino_minimap_hud_y': 80,
        'powerplay_hud_x': 820,
        'powerplay_hud_y': 490,
        'hud_x': 100,
        'hud_y': 100,
