...
if __name__ == "__main__" and "--html-overlay-host" in sys.argv:
    from voidcompass.overlays.html_overlay_host import main as _run_html_overlay_host
...
if __name__ == "__main__" and "--html-dashboard-host" in sys.argv:
    from voidcompass.dashboard.html_dashboard_host import main as _run_html_dashboard_host
