...
from voidcompass.core.config import (
...
from voidcompass.core.theme_state import apply_theme_live
...
from voidcompass.overlays.cargo_hud import CargoHUD, cargo_capacity_for
from voidcompass.overlays.carrier_hud import CarrierHUD
from voidcompass.services.edsm_handler import EDSMHandler
from voidcompass.core.screenshot_handler import ScreenshotHandler
...
from voidcompass.overlays.html_station_overlay import attach_html_station_overlay
from voidcompass.overlays.html_cargo_overlay import attach_html_cargo_overlay
...
from voidcompass.services.galnet import GalnetFeedService
...
from voidcompass.exploration.stellar_cartography import edsm_bodies_to_orrery_items
from voidcompass.exploration.expedition_manager import ExpeditionManager
from voidcompass.core.diagnostic_logs import application_base_dir, resolve_log_path
from voidcompass.core.adaptive_command import (
...
from voidcompass.core.persistence_queue import flush_persistence, persistence_queue
...
from voidcompass.core.global_hotkeys import GlobalHotkeyManager, OVERLAY_HOTKEY_SPECS
from voidcompass.core.platform_support import default_screenshot_path, open_path
...
class MainDashboard(
    ...
    def _copy_legacy_to_profile(self, filename, fallback_source=None):
        src = os.path.abspath(filename)
        if not os.path.exists(src) and fallback_source is not None:
            src = os.fspath(fallback_source)
    ...
    def _refresh_profile_paths(self):
        ...
        self.config["mining_db_file"] = self._copy_legacy_to_profile(
            "mining_data.db", resource_path("data", "mining_data.db"),
        )
