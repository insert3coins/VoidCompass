...
(async () => {
  ...
  try {
    ...
    await page.evaluate(() => renderPlanetMaterialsWorkspace({profile_key:'test',system:'Sol',body:'Moon',current_position:{system:'Sol',body:'Moon',latitude:0,longitude:-180},mining_catalogue:['Diamond','Ruby','Sapphire','Bastnasite'],new_mining_materials:['Diamond','Ruby','Sapphire','Bastnasite'],sites:[{id:1,system:'Sol',body:'Moon',name:'Western deposit',latitude:0,longitude:-180,materials:'Diamond, Osmium',notes:'Dense deposits'}],resources:{bodies:[{body:'Moon',class:'Rocky body',landable:true,mining_locations:3,materials:[{name:'Iron',percent:18.2},{name:'Yttrium',percent:1.1,rare:true}]}]}}));
