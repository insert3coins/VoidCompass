...
PUBLIC_RUNTIME_IMAGE_DOCUMENTS = {
    ...
    "assets/images/people/README.md",
    "assets/images/ships/README.md",
}
REQUIRED_RUNTIME_IMAGES = {
    "assets/images/Galaxy/voidcompass-galactic-atlas.png",
}
...
def validate_runtime_images(project: str | Path) -> set[str]:
    ...
    source_root = project / "assets" / "images"
...
def create_release(
    ...
    _copy_required(
        project / "data" / "codexRef.json",
        package_dir / "data" / "codexRef.json",
    )
    _sanitize_mining_database(
        project / "data" / "mining_data.db",
        package_dir / "data" / "mining_data.db",
    )
